...
import com.codebele.aahara.BuildConfig;
import com.codebele.aahara.Interface.PrferenceCountryInterface;
...
public class CountryCodePicker extends RelativeLayout {
  ...
  private PrferenceCountryInterface prferenceCountryInterface;
  ...
  private void applyCustomProperty(AttributeSet attrs) {
    ...
    try {
      ...
      if (textSize > 0) {
        ...
        int defaultSize = Math.round(20 * (dm.xdpi/ DisplayMetrics.DENSITY_DEFAULT));
...
//    prferenceCountryInterface.startActivity();

//    context.startActivity(new Intent(context, CustomCountryCodePickerActivity.class));



    if (mCountryCodeDialog == null) mCountryCodeDialog = new CountryCodeDialog(this);
    mCountryCodeDialog.getWindow().setBackgroundDrawable(getResources().getDrawable(R.drawable.background_white));
